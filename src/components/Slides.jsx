...
export const PercentSlide = React.memo(function PercentSlide({ data, theme, textColor }) {
    return (
      <SlideContainer textColor={textColor} centerContent={true}>
        ...
        <div className="flex-1 flex flex-col justify-evenly w-full items-center gap-8 pt-8">
            <motion.div
            ...
            >
                <p className="text-lg">For comparison, you spent about <span className="font-bold">29%</span> of your year sleeping.</p>
            </motion.div>
...
export const OlympicsSlide = React.memo(function OlympicsSlide({ data, textColor }) {
...
export const ShortestSlide = React.memo(function ShortestSlide({ data, textColor }) {
      ...
      <SlideContainer textColor={textColor}>
        ...
        <div className="flex-1 flex flex-col justify-center w-full items-center">
            <motion.div
                ...
                className="flex items-end justify-center gap-1 mb-8 mt-12"
            >
    ...
    return (
      <SlideContainer textColor={textColor} centerContent={true}>
        ...
        <div className="flex-1 flex flex-col justify-start pt-8 gap-8 w-full items-center">
            ...
            <div className="flex flex-col gap-8 text-xl font-bold mt-12">
                <motion.p
                    initial={{ x: -50, opacity: 0 }}
                    animate={{ x: 0, opacity: 1 }}
                    transition={{ delay: DRAMATIC_DELAY }}
...
export const SpeedSlide = React.memo(function SpeedSlide({ data, textColor }) {
    return (
      <SlideContainer textColor={textColor} centerContent={true}>
        ...
        <div className="flex-1 flex flex-col justify-evenly pt-8 gap-8 w-full items-center">
            <motion.div
                animate={{ x: [-10, 10, -10] }}
...
export const SlowestSlide = React.memo(function SlowestSlide({ data, textColor }) {
    ...
    return (
        <SlideContainer textColor={textColor} centerContent={true}>
            ...
            <div className="flex-1 flex flex-col justify-center gap-6 w-full items-center">
                <motion.div
...
export const KudosSlide = React.memo(function KudosSlide({ data, textColor }) {
      ...
      <SlideContainer textColor={textColor} centerContent={true}>
          ...
          <div className="flex-1 flex flex-col justify-start gap-8 w-full items-center pt-8 pb-24">
              <motion.div
                ...
                className="p-8 border-4 border-current rounded-3xl relative flex flex-col gap-6 items-center"
              >
                  <div className="text-5xl md:text-7xl">🆕</div>
                  <div className="text-2xl md:text-4xl font-black uppercase">{data.newActivity.type}</div>
                  <p className="opacity-80">Tried on {new Date(data.newActivity.firstDate).toLocaleDateString()}</p>
                  ...
                  {data.newActivity.id && (
                      <motion.a
                          ...
                          initial={{ opacity: 0, y: 10 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ delay: DRAMATIC_DELAY + 0.2 }}
                          className="absolute -bottom-14 left-0 right-0 mx-auto w-max px-6 py-2 bg-white/20 hover:bg-white/30 rounded-full text-sm font-bold uppercase tracking-wider backdrop-blur-sm transition-colors"
                      >
                          View on Strava
                      </motion.a>
...
export const LocationSlide = React.memo(function LocationSlide({ data, textColor }) {
    ...
    return (
        <SlideContainer textColor={textColor} centerContent={true}>
            ...
            <div className="flex-1 flex flex-col justify-evenly gap-8 w-full items-center pt-8">
                <motion.div
...
export const TopMonthsSlide = React.memo(function TopMonthsSlide({ data, textColor }) {
    ...
    const topMonth = data.topMonthsByDistance[0]?.month || "this year";
        ...
        <SlideContainer textColor={textColor}>
            ...
            <div className={clsx(BaseContentClass, "pt-8")}>
                    ...
                    {data.monthlyStats.map((stat, idx) => {
                        ...
                        return (
                            <motion.div
                                ...
                                animate={{ scale: 1, opacity: 1 }}
                                transition={{ delay: DRAMATIC_DELAY - 1 + (idx * 0.05) }}
                ...
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: BASE_WRITE_DELAY + 2.5 }}
                    className="max-w-md bg-white/10 p-6 rounded-xl backdrop-blur-sm mt-4"
                >
                    <p className="text-xl font-bold italic opacity-90">
                        &quot;{topMonth} was absolutely legendary!&quot;
                    </p>
                </motion.div>
            </div>
        </SlideContainer>
...
export const SummarySlide = React.memo(function SummarySlide({ data, theme, textColor, traits }) {
    const ref = React.useRef(null);
...
export const TopSportsSlide = React.memo(function TopSportsSlide({ data, textColor }) {
    return (
      <SlideContainer textColor={textColor}>
        ...
        <div className="flex-1 flex flex-col justify-center pb-20 pt-4 w-full items-center">
...
export const SpotlightSlide = React.memo(function SpotlightSlide({ data, textColor }) {
...
export const VibeSlide = React.memo(function VibeSlide({ data, textColor, traits }) {
    // Ensure array
