...
**Learning:** In client-side only applications (like this one using implicit/PKCE flow without a backend proxy), secrets are inevitably exposed to the user. However, using `localStorage` increases the risk in shared environments.
