...
const StoryContainer = ({ data, onClose, playEntrySound }) => {
  ...
  const slides = useMemo(() => {
      ...
      return [
        ...
        ...(hasNewActivity ? [{ component: (props) => <NewActivitySlide data={data} {...props} />, duration: 6000 }] : []),
        ...
        // 8. SOCIAL & FAVORITES
        ...(hasSpotlight ? [{ component: (props) => <SpotlightSlide data={data} {...props} />, duration: 7000 }] : []),
